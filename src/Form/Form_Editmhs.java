 ...
 * @author Lenovo
 */
public class Form_Editmhs extends javax.swing.JFrame {
    ButtonGroup jek;
    /**
     * Creates new form Form_Editmhs
     */
    public Form_Editmhs() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jComboBox3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Get Data" }));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            db.hasil = db.statemen.executeQuery("Select nama_mhs from mhs");
            jComboBox3.removeAllItems();
            jComboBox3.addItem("Pilih Data");
            while(db.hasil.next()){
                jComboBox3.addItem(db.hasil.getString(1));
            }
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        // TODO add your handling code here:
        database db = new database();
        Object nama=jComboBox3.getSelectedItem();
        db.connect();
        ...
        try{
            ...
            db.koneksi = DriverManager.getConnection(dburl);
            db.statemen = db.koneksi.createStatement();
            db.hasil = db.statemen.executeQuery("Select * from mhs where nama_mhs = '"+nama+"'");
            while(db.hasil.next()){
                jTextField1.setText(db.hasil.getString(1));
                jTextField2.setText(db.hasil.getString(2));
                if(db.hasil.getInt(3)==1){
                    jRadioButton1.setSelected(true);
                }else{
                    jRadioButton2.setSelected(true);
                }
                jComboBox1.setSelectedIndex(db.hasil.getInt(4));
                if(db.hasil.getString(5).equals("KA")){
                    jComboBox2.setSelectedIndex(1);
                }else if(db.hasil.getString(5).equals("IA")){
                    jComboBox2.setSelectedIndex(2);
                }else{
                    jComboBox2.setSelectedIndex(3);
                }
                jTextArea1.setText(db.hasil.getString(6));
            }
        }catch(SQLException sqlex){
            sqlex.printStackTrace();
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        jek.add(jRadioButton1);
        jek.add(jRadioButton2);
        int jk, ting = jComboBox1.getSelectedIndex();
        String npm = jTextField1.getText(), nama = jTextField2.getText(), alamat = jTextArea1.getText();
        String jurusan;
        ...
        db.updatemhs(npm,nama,jk,ting,jurusan,alamat);
        this.hide();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Editmhs.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_Editmhs().setVisible(true);
            }
        });
